...
{
    /// <inheritdoc />
    public partial class AddMissedConnection : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserType = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PersonDescription = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissedConnections", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestResponds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestResponds_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuestResponds_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Games_PartyDetails_PartyDetailsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameCurrentPlayer", x => new { x.GameId, x.UserId });
                    table.ForeignKey(
                        name: "FK_GameCurrentPlayer_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameCurrentPlayer_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameWaitingPlayer", x => new { x.GameId, x.UserId });
                    table.ForeignKey(
                        name: "FK_GameWaitingPlayer_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameWaitingPlayer_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5d06e9fd-7fc9-4c01-b28b-e901a2eeca75"), null, "User", "USER" },
                    { new Guid("fd85c196-4d0f-45b5-be0b-65d8f46ac604"), null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("cb093557-041c-4e95-a177-62dae9526163"), 0, "850f6f7c-f5e6-4f2c-8053-88e16daafa30", "admin@festiv.com", true, "Admin", "User", false, null, "ADMIN@FESTIV.COM", "ADMIN@FESTIV.COM", "AQAAAAIAAYagAAAAEOulKe0S0Tc6kvK64OfHNl+lY6sDguXtj8Vs1egT7fb59oRAaweCOxLjPAUySc4RPw==", null, false, null, 0, "", false, "admin@festiv.com", true });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("fd85c196-4d0f-45b5-be0b-65d8f46ac604"), new Guid("cb093557-041c-4e95-a177-62dae9526163") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_PartyDetailsId",
                table: "Games",
                column: "PartyDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_PartyId",
                table: "Games",
                column: "PartyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestResponds_PartyId",
                table: "GuestResponds",
                column: "PartyId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestResponds_UserId",
                table: "GuestResponds",
                column: "UserId");
